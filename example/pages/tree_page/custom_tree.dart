          ...
          children: <TreeViewNode<String>>[
            ...
            TreeViewNode<String>(
              ...
              children: <TreeViewNode<String>>[
                ...
                TreeViewNode<String>('render_tree.dart2'),
                TreeViewNode<String>('tree_core.dart2'),
                TreeViewNode<String>('tree_delegate.dart2'),
                TreeViewNode<String>('tree_span.dart2'),
                TreeViewNode<String>('tree.dart2'),
                TreeViewNode<String>('render_tree.dart3'),
                TreeViewNode<String>('tree_core.dart3'),
                TreeViewNode<String>('tree_delegate.dart3'),
                TreeViewNode<String>('tree_span.dart3'),
                TreeViewNode<String>('tree.dart3'),
                TreeViewNode<String>('render_tree.dart4'),
                TreeViewNode<String>('tree_core.dart4'),
                TreeViewNode<String>('tree_delegate.dart4'),
                TreeViewNode<String>('tree_span.dart4'),
                TreeViewNode<String>('tree.dart4'),
              ],
            ),
          ],
        ),
